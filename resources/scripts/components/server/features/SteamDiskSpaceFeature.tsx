            ...
            {isAdmin ? (
                <>
                    <div css={tw`mt-4 sm:flex items-center`}>
                        <h2 css={tw`text-2xl mb-4 text-gray-100 `}>Out of available disk space...</h2>
                    </div>
                    <p css={tw`mt-4`}>
                    ...
                    <p css={tw`mt-4`}>
                        ...
                        <code css={tw`font-mono bg-gray-900 rounded py-1 px-2`}>df -h</code> on the machine hosting
